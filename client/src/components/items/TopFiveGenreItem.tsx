    ...
    return (
        ...
        {index % 2 !== 0
            ...
            <Box display={"flex"} bgcolor={"#D9D9D9"} height={"160px"}>
                <Box borderRadius={'1000px 0px 0px 1000px'} width={"100%"} display={"fles"} bgcolor={"#919496"}>
                    <Box borderRadius={'1000px 1000px 1000px 1000px'} bgcolor={"white"} width={"60%"} height={"100%"}>
                ...
                <Box bgcolor={"black"} width={"135px"} height={"80px"}>
            ...
            <Box display={"flex"} bgcolor={"#D9D9D9"} height={"160px"}>
                ...
                <Box borderRadius={'0px 1000px 1000px 0px'} width={"100%"} display={"flex"} justifyContent={"flex-end"} bgcolor={"#919496"}>
                    ...
                    <Box borderRadius={'1000px 1000px 1000px 1000px'} bgcolor={"white"} width={"60%"} display={"flex"} justifyContent={"flex-end"}>
                        <IconButton sx={{padding: 0}}>
                            <Box component={"img"} src={diskImage} borderRadius={'50%'} width={"160px"}
                                 height={"160px"}/>
                        </IconButton>
