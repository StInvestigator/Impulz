...
VALUES
-- AC/DC (Rock/Metal)
(31, 2), (31, 9),   -- Thunderstruck (Rock/Metal)
(32, 2), (32, 9),   -- The Razors Edge (Rock/Metal)
(33, 2),            -- Moneytalks (Rock)
(34, 2), (34, 9),   -- If You Dare (Rock/Metal)
(35, 2), (35, 9),   -- Fire Your Guns (Rock/Metal)
(36, 2),            -- Are You Ready (Rock)
(37, 2),            -- Touch Too Much (Rock)
(38, 2),            -- Love Hungry Man (Rock)
(39, 2), (39, 9),   -- Highway to Hell (Rock/Metal)
(40, 2),            -- Girls Got Rhythm (Rock)
(41, 2),            -- Get It Hot (Rock)
(42, 2),            -- You Shook Me All Night Long (Rock)
(43, 2), (43, 9),   -- Shoot to Thrill (Rock/Metal)
(44, 2),            -- Let Me Put My Love Into You (Rock)
(45, 2), (45, 9),   -- Hells Bells (Rock/Metal)
(46, 2), (46, 9),   -- Back In Black (Rock/Metal)

-- Megadeth (Metal)
(47, 9), (47, 2),   -- Take No Prisoners (Metal/Rock)
(48, 9), (48, 2),   -- Rust In Peace... Polaris (Metal/Rock)
(49, 9),            -- My Creation (Metal)
(50, 9), (50, 2),   -- Holy Wars... The Punishment Due (Metal/Rock)
(51, 9), (51, 2),   -- Hangar 18 (Metal/Rock)
(52, 9),            -- Dawn Patrol (Metal)
(53, 9), (53, 2),   -- Wake Up Dead (Metal/Rock)
(54, 9), (54, 2),   -- Peace Sells (Metal/Rock)
(55, 9),            -- My Last Words (Metal)
(56, 9), (56, 2),   -- Good Mourning/Black Friday (Metal/Rock)
(57, 9), (57, 2),   -- Devils Island (Metal/Rock)
...
(63, 2), (63, 7),   -- Another One Bites The Dust (Rock/Hip-Hop)
...
(70, 9), (70, 2),   -- Warning (Metal/Rock)
(71, 9), (71, 2),   -- N.I.B. (Metal/Rock)
(72, 9), (72, 2),   -- Evil Woman (Metal/Rock)
(73, 9), (73, 2),   -- Black Sabbath (Metal/Rock)
(74, 9), (74, 2),   -- Behind The Wall Of Sleep (Metal/Rock)
(75, 9), (75, 2),   -- War Pigs (Metal/Rock)
(76, 9), (76, 2),   -- Rat Salad (Metal/Rock)
(77, 9), (77, 2),   -- Paranoid (Metal/Rock)
(78, 9), (78, 2),   -- Iron Man (Metal/Rock)
(79, 9), (79, 2),   -- Hand Of Doom (Metal/Rock)
(80, 9), (80, 2),   -- Electric Funeral (Metal/Rock)

-- Beyonce (Pop/R&B)
(81, 1), (81, 7),   -- 6 Inch (Pop/Hip-Hop)
(82, 1), (82, 7),   -- Freedom (Pop/Hip-Hop)
(83, 1),            -- Sorry (Pop)
(84, 1),            -- Sandcastles (Pop)
(85, 1),            -- Love Drought (Pop)
(86, 1), (86, 7),   -- Formation (Pop/Hip-Hop)
(87, 1),            -- All Night (Pop)
(88, 1),            -- Yes (Pop)
(89, 1),            -- Work It Out (Pop)
(90, 1), (90, 7),   -- Naughty Girl (Pop/Hip-Hop)
(91, 1), (91, 7),   -- Hip Hop Star (Pop/Hip-Hop)
(92, 1),            -- Gift from Virgo (Pop)
(93, 1),            -- Be With You (Pop)

-- Lady Gaga (Pop/Electronic)
(94, 1), (94, 6),   -- The Fame (Pop/Electronic)
(95, 1),            -- Speechless (Pop)
(96, 1), (96, 6),   -- Poker Face (Pop/Electronic)
(97, 1), (97, 6),   -- Paper Gangsta (Pop/Electronic)
(98, 1), (98, 6),   -- Monster (Pop/Electronic)
(99, 1), (99, 6),   -- Money Honey (Pop/Electronic)
(100, 1), (100, 6), -- Dance In The Dark (Pop/Electronic)
(101, 1), (101, 6), -- Boys Boys Boys (Pop/Electronic)
(140, 1),           -- Perfect Illusion (Pop)
(141, 1),           -- Just Another Day (Pop)
(142, 1),           -- Joanne (Pop)
(143, 1),           -- Grigio Girls (Pop)
(144, 1), (144, 6), -- Dancin' In Circles (Pop/Electronic)
(145, 1),           -- Come To Mama (Pop)
(146, 1),           -- Angel Down (Pop)

-- 50 Cent (Hip-Hop/Rap)
(102, 7), (102, 4), -- My Toy Soldier (Hip-Hop/Rap)
(103, 7), (103, 4), -- So Amazing (Hip-Hop/Rap)
(104, 7), (104, 4), -- Build You Up (Hip-Hop/Rap)
(105, 7), (105, 4), -- This Is 50 (Hip-Hop/Rap)
(106, 7), (106, 4), -- Piggy Bank (Hip-Hop/Rap)
(107, 7), (107, 4), -- In My Hood (Hip-Hop/Rap)
(108, 7), (108, 4), -- I Don't Need 'Em (Hip-Hop/Rap)
(109, 7), (109, 4), -- A Baltimore Love Thing (Hip-Hop/Rap)
(110, 7), (110, 4), -- Patiently Waiting (Hip-Hop/Rap)
(111, 7), (111, 4), -- What Up Gangsta (Hip-Hop/Rap)
(112, 7), (112, 4), -- U Not Like Me (Hip-Hop/Rap)
(113, 7), (113, 4), -- Poor Lil Rich (Hip-Hop/Rap)
(114, 7), (114, 4), -- Life's On The Line (Hip-Hop/Rap)
(115, 7), (115, 4), -- If I Can't (Hip-Hop/Rap)
(116, 7), (116, 4), -- Gotta Make It To Heaven (Hip-Hop/Rap)
(117, 7), (117, 4), -- Back Down (Hip-Hop/Rap)

-- Eminem (Rap/Hip-Hop)
(118, 4), (118, 7), -- Never Enough (Rap/Hip-Hop)
(119, 4), (119, 7), -- Puke (Rap/Hip-Hop)
(120, 4),           -- Paul (Rap)
(121, 4), (121, 7), -- My 1st Single (Rap/Hip-Hop)
(122, 4), (122, 7), -- Mosh (Rap/Hip-Hop)
(123, 4),           -- Final Thought (Rap)
(124, 4), (124, 7), -- Evil Deeds (Rap/Hip-Hop)
(125, 4), (125, 7), -- Crazy In Love (Rap/Hip-Hop)
(126, 4), (126, 7), -- Big Weenie (Rap/Hip-Hop)
(127, 4), (127, 7), -- Drips (Rap/Hip-Hop)
(128, 4), (128, 7), -- Till I Collapse (Rap/Hip-Hop)
(129, 4), (129, 7), -- My Dad's Gone Crazy (Rap/Hip-Hop)
(130, 4), (130, 7), -- Without Me (Rap/Hip-Hop)
(131, 4),           -- The Kiss (Rap)
(132, 4), (132, 7), -- Square Dance (Rap/Hip-Hop)
(133, 4),           -- Paul Rosenberg (Rap)
(134, 4), (134, 7), -- Hailie's Song (Rap/Hip-Hop)
(135, 4), (135, 7), -- Hailie's Song (Rap/Hip-Hop)
